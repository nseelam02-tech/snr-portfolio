    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-gray-50">
      ...
      <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-white to-blue-50/30 pt-20 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute top-20 left-10 text-6xl font-mono text-slate-200/40 animate-pulse opacity-20 select-none">{'</>'}</div>
          <div className="absolute top-40 right-20 text-4xl font-mono text-blue-200/50 animate-pulse opacity-30 select-none" style={{ animationDelay: '1s' }}>{'{ }'}</div>
          <div className="absolute bottom-40 left-20 text-5xl font-mono text-indigo-200/40 animate-pulse opacity-25 select-none" style={{ animationDelay: '2s' }}>{'<div/>'}</div>
          <div className="absolute bottom-20 right-40 text-3xl font-mono text-slate-300/40 animate-pulse opacity-20 select-none" style={{ animationDelay: '3s' }}>{'function()'}</div>
          
          {/* Refined geometric shapes */}
          <div className="absolute top-32 right-10 w-20 h-20 border-2 border-blue-300/30 rotate-45 animate-spin opacity-20" style={{ animationDuration: '20s' }}></div>
          <div className="absolute bottom-32 left-16 w-16 h-16 bg-gradient-to-r from-blue-200/40 to-indigo-200/40 rounded-full animate-bounce opacity-30" style={{ animationDelay: '1s' }}></div>
          <div className="absolute top-1/2 right-32 w-12 h-12 border-2 border-slate-300/40 animate-pulse opacity-25" style={{ animationDelay: '2s' }}></div>
          ...
          <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-tr from-slate-100/30 to-blue-100/30 rounded-full opacity-40 animate-pulse blur-3xl" style={{ animationDelay: '1s' }}></div>
      ...
      <section id="work" className="py-32 bg-gradient-to-br from-slate-50/80 via-gray-50 to-blue-50/20 relative">
      ...
      <section id="interests" className="py-32 bg-gradient-to-br from-white via-slate-50/30 to-indigo-50/20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
      ...
      <section id="blog" className="py-32 bg-gradient-to-br from-slate-50/60 via-gray-50/80 to-blue-50/30 relative">
        {/* Dot pattern overlay */}
      ...
      <section id="contact" className="py-32 bg-gradient-to-br from-slate-50/70 via-gray-50 to-blue-50/20 relative">
