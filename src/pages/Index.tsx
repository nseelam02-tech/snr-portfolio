  ...
  const blogPosts = [
    {
      ...
      excerpt:
        'A traditional coastal recipe passed down through generations, bringing authentic flavors and aromatic spices to your kitchen...',
      image: '/SNR-uploads/c1a06e2b-5481-476d-9bf6-b4fa1db8e6e3.png',
      date: 'March 15, 2024',
      readTime: '8 min read',
    },
    {
      ...
      excerpt:
        'Learn to make this classic Indian sweet that melts in your mouth with just seven simple ingredients and traditional cooking methods...',
      image: '/SNR-uploads/2ebfd292-a648-4106-8113-e385a115024f.png',
      date: 'March 10, 2024',
      readTime: '6 min read',
    },
    {
      ...
      excerpt:
        'Discover the secrets behind creating the perfect pizza dough that rivals authentic Italian pizzerias with traditional techniques and modern tips...',
      image: '/SNR-uploads/a0d3e689-310f-4a3c-a5d0-15fbc6039e15.png',
      date: 'March 5, 2024',
      readTime: '5 min read',
    },
  ]
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center transform hover:scale-105 transition-transform duration-200">
              <img
                src="/SNR-uploads/977cc23d-9302-4d1c-9aae-a2e22dbbb34d.png"
                alt="SNR Logo"
      ...
      <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-white to-blue-50/30 pt-20 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div
            className="absolute top-40 right-20 text-4xl font-mono text-blue-200/50 animate-pulse opacity-30 select-none"
            style={{ animationDelay: '1s' }}
          >
            {'{ }'}
          </div>
          <div
            className="absolute bottom-40 left-20 text-5xl font-mono text-indigo-200/40 animate-pulse opacity-25 select-none"
            style={{ animationDelay: '2s' }}
          >
            {'<div/>'}
          </div>
          <div
            className="absolute bottom-20 right-40 text-3xl font-mono text-slate-300/40 animate-pulse opacity-20 select-none"
          ...
          ></div>
          <div
            className="absolute bottom-32 left-16 w-16 h-16 bg-gradient-to-r from-blue-200/40 to-indigo-200/40 rounded-full animate-bounce opacity-30"
            style={{ animationDelay: '1s' }}
          ></div>
          <div
            ...
            <div className="space-y-6">
              <h1 className="text-5xl md:text-7xl font-thin tracking-tight text-gray-900">
                <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-6 min-h-[80px] md:min-h-[100px]">
                  <span className="relative h-20 md:h-24 flex items-center justify-center">
                    <span
                      className="inline-block bg-gradient-to-r from-blue-600 via-purple-600 to-emerald-600 bg-clip-text text-transparent font-semibold tracking-wide animate-slideUp"
              ...
              <div
                className="h-1 w-32 bg-gradient-to-r from-blue-500 via-purple-500 to-emerald-500 mx-auto rounded-full animate-scaleX"
              ...
              <div className="flex flex-wrap gap-3">
                {skills.map((skill, index) => (
                  <Badge
                    key={index}
                    variant="secondary"
                    className="px-4 py-2 text-sm font-medium bg-gray-100 hover:bg-gray-200 transition-all duration-200 hover:scale-105 cursor-default"
                  >
                    {skill}
                  </Badge>
                ))}
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto font-light leading-relaxed">
              Beyond coding, I'm passionate about exploring cultures through
              food, travel, and creative expression. These interests fuel my
              creativity and bring fresh perspectives to my work.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {interests.map((interest, index) => (
              <Card
                key={index}
                className={`text-center animate-fade-in border-2 shadow-lg hover:shadow-xl transition-all duration-500 rounded-3xl overflow-hidden group cursor-pointer transform hover:scale-105 ${interest.color}`}
              >
                <CardHeader className="p-8">
                  <div className="flex justify-center mb-6 text-gray-700 group-hover:scale-110 transition-transform duration-300">
                    {interest.icon}
                  </div>
                  <CardTitle className="text-xl font-medium text-gray-900 mb-6">
                    {interest.category}
                  </CardTitle>
                </CardHeader>
                <CardContent className="p-8 pt-0">
                  <div className="space-y-3">
                    {interest.items.map((item, itemIndex) => (
                      <div
                        key={itemIndex}
                        className="text-gray-600 text-sm font-light bg-white/50 rounded-full px-4 py-2 hover:bg-white/70 transition-colors duration-200"
                      >
                        {item}
                      </div>
                    ))}
      ...
      <section className="py-32 bg-gradient-to-b from-white to-slate-50/40">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto font-light leading-relaxed">
              Connect with me across various platforms and follow my latest
              content, projects, and creative collaborations.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="space-y-6">
              {mediaChannels.map((channel, index) => (
                ...
                >
                  <div
                    className={`w-14 h-14 bg-gradient-to-r ${channel.color} rounded-xl flex items-center justify-center text-white font-bold text-lg shadow-lg group-hover:scale-110 transition-transform duration-200`}
                  >
            ...
            <div className="grid lg:grid-cols-2 gap-20">
              ...
              >
                ...
                <Button
                  type="submit"
                  size="lg"
                  className="w-full bg-black hover:bg-gray-800 text-white h-12 rounded-xl font-medium transition-all duration-200 hover:scale-105 transform"
                >
                  Send Message
